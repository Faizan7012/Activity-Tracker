...
<ChakraProvider>
    <Box>
      ...
      <Flex p="70px 0" justifyContent="center" gap="50px">
        <Stack w="52%" textAlign="left" spacing="20px">
          ...
          <Grid templateColumns="repeat(2, 1fr)" fontSize="18px" gap="30px">
            <Box>
              ...
              <Text>
                Skyrocket effectiveness Know who's doing what and how it's going
            ...
            <Box>
              ...
              <Text>
                Organize shifts, absences, and booking-related questions all in
                one place.
              </Text>
            </Box>
            <Box>
      ...
      <Flex p="70px 0" justifyContent="center" alignItems="center" gap="50px">
